...
# Usage message
usage:
	@echo "# Usage: make [all|refs|fastq|index|align|stats|bam|vcf|clean|vep|snpeff]"
...
all: refs fastq index align stats bam vcf vep 
...
# PHONY targets
.PHONY: usage refs fastq index align stats bam vcf vep snpeff all clean
